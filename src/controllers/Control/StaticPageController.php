...
use Iankov\ControlPanelStatic\Controllers\Controller;
...
class StaticPageController extends Controller
{
    ...
    {
        return view('icp-static::static.index');
    }
    ...
    {
        return view('icp-static::static.edit', [
    ...
    {
        return view('icp-static::static.create', [
            'page' => new StaticPage()
        ]);
    }
